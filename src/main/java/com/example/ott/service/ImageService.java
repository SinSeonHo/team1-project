...
public class ImageService {
    ...
    // */
    // public Image uploadAndSave(MultipartFile file, Long movieId, int ord) throws
    // IOException {
    // // 1. 원본 파일명 유효성 검사
    ...
    // // DB에는 baseDir 제외한 상대 경로(예: "2025-06-10/uuid.jpg")를 저장하면, 환경별 baseDir이 달라도
    // 일관된
    // // URL 매핑이 가능
    ...
    // * @return List<Image>
    // */
    // public List<Image> getImagesByMovie(Long movieId) {
    // // ImageRepository에 findByMovieId 메서드가 있다면 사용하거나,
    // // 기본적으로 imageRepository.findAll() 후 filter하거나, @Query 추가
    // return imageRepository.findAllByMovieInum(movieId);
    // // 위 메서드가 없다면 ImageRepository에 다음과 같이 정의해야 함:
